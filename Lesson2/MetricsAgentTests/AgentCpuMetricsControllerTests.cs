...
namespace MetricsAgentTests
{
    ...
    public class AgentCpuMetricsControllerTests
    {
        private AgentCpuMetricsController _cpuMetricsController;

        public AgentCpuMetricsControllerTests()
        {
            _cpuMetricsController = new AgentCpuMetricsController();
        }
